...
4. Every manifest entry should declare coverage themes and semantic expectations.
5. Reference tests may assert structural and fallback invariants, but they must not replace local exact-output assertions.
